 ...
 *
 * Disassembly of DSDT.aml, Wed Dec 26 10:51:35 2018
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0001C97C (117116)
 *     Revision         0x02
 *     Checksum         0x6B
 *     OEM ID           "XIAOMI"
 ...
 */
DefinitionBlock ("", "DSDT", 2, "XIAOMI", "SKL-ULT", 0x00000000)
{
    /*
    ...
    External (_SB_.PCI0.RP01.PXSX.DEOF, IntObj)
    External (_SB_.PCI0.RP01.PXSX.GESC, IntObj)
    ...
    Name (SS3, One)
    Name (SS4, One)
    OperationRegion (GNVS, SystemMemory, 0x7CE62698, 0x0635)
    ...
    OperationRegion (OGNS, SystemMemory, 0x7CE63F18, 0x0000000C)
        ...
        Method (IICB, 2, Serialized)
        {
            Switch (Arg1)
            {
                Case (Zero)
                {
                    ...
                    CreateWordField (IIC0, \_SB.PCI0.IICB._Y26._ADR, DAD0)  // _ADR: Address
                    Store (Arg0, DAD0)
                    Return (IIC0)
                }
                Case (One)
                {
                    ...
                    CreateWordField (IIC1, \_SB.PCI0.IICB._Y27._ADR, DAD1)  // _ADR: Address
                    Store (Arg0, DAD1)
                    Return (IIC1)
                }
                Case (0x02)
                {
                    ...
                    CreateWordField (IIC2, \_SB.PCI0.IICB._Y28._ADR, DAD2)  // _ADR: Address
                    Store (Arg0, DAD2)
                    Return (IIC2)
                }
                Case (0x03)
                {
                    ...
                    CreateWordField (IIC3, \_SB.PCI0.IICB._Y29._ADR, DAD3)  // _ADR: Address
                    Store (Arg0, DAD3)
                    Return (IIC3)
                }
                Case (0x04)
                {
                    ...
                    CreateWordField (IIC4, \_SB.PCI0.IICB._Y2A._ADR, DAD4)  // _ADR: Address
                    Store (Arg0, DAD4)
                    Return (IIC4)
                }
                Default
                {
                    ...
                    CreateWordField (IIC5, \_SB.PCI0.IICB._Y2B._ADR, DAD5)  // _ADR: Address
                    Store (Arg0, DAD5)
                    Return (IIC5)
                }
    ...
    Scope (\)
    {
        OperationRegion (CNVS, SystemMemory, 0x7CE7D018, 0x00000800)
    ...
    Scope (_SB.PCI0.I2C1)
    {
        Device (TPD0)
        {
            ...
            CreateDWordField (SBFI, \_SB.PCI0.I2C1.TPD0._Y2C._INT, INT2)  // _INT: Interrupts
        ...
        Device (TPD1)
        {
            ...
            CreateDWordField (SBFI, \_SB.PCI0.I2C1.TPD1._Y2D._INT, INT2)  // _INT: Interrupts
            CreateWordField (SBFG, 0x17, INT1)
            Method (_INI, 0, NotSerialized)  // _INI: Initialize
            {
                If (LLess (OSYS, 0x07DC))
    ...
    Scope (_SB.PCI0.XHC)
    {
        Method (RSPP, 0, Serialized)
        {
            ...
            If (LAnd (LEqual (PPLS, 0x07), LEqual (PCCS, Zero)))
            {
                If (LEqual (PTPP, One))
                {
                    Store (Zero, PTPP)
