 ...
 *
 * Disassembly of SSDT-14.aml, Sat Aug 11 00:50:48 2018
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x000039B2 (14770)
 *     Revision         0x01
 *     Checksum         0x32
 *     OEM ID           "XIAOMI"
 ...
 */
DefinitionBlock ("", "SSDT", 1, "XIAOMI", "SKL-ULT", 0x00001000)
{
    /*
    ...
    External (_PR_.CPU1._PPC, UnknownObj)    // (from opcode)
    External (_PR_.CPU2, ProcessorObj)    // (from opcode)
    External (_PR_.CPU2._PPC, UnknownObj)    // (from opcode)
    External (_PR_.CPU3, ProcessorObj)    // (from opcode)
    External (_PR_.CPU3._PPC, UnknownObj)    // (from opcode)
    External (_SB_.GGIV, MethodObj)    // 1 Arguments (from opcode)
    External (_SB_.OSCO, IntObj)    // (from opcode)
    ...
    External (_SB_.PCI0.LPCB.EC0_.COVT, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.LPCB.EC0_.EGPS, MethodObj)    // 0 Arguments (from opcode)
    External (_SB_.PCI0.LPCB.EC0_.ERPL, MethodObj)    // 0 Arguments (from opcode)
    External (_SB_.PCI0.LPCB.EC0_.EWGC, MethodObj)    // 1 Arguments (from opcode)
    External (_SB_.PCI0.LPCB.EC0_.EWPL, MethodObj)    // 1 Arguments (from opcode)
    ...
    External (_TZ_.TBSE, IntObj)    // (from opcode)
    ...
    External (MMCH, IntObj)    // (from opcode)
    External (P8XH, MethodObj)    // 2 Arguments (from opcode)
    External (PNOT, MethodObj)    // 0 Arguments (from opcode)
    External (STMS, MethodObj)    // 1 Arguments (from opcode)

    Scope (\_SB.PCI0.RP01.PXSX)
    {
        OperationRegion (VBOR, SystemMemory, 0x7CE04018, 0x00040004)
    ...
    Scope (\_SB.PCI0.RP01.PXSX)
    {
        OperationRegion (SGOP, SystemMemory, 0x7BBACF98, 0x4A)
    ...
    Scope (\_SB.PCI0.RP01.PXSX)
    {
        OperationRegion (NOPR, SystemMemory, 0x7CE69018, 0x2010)
    ...
    Scope (\_SB.PCI0.RP01)
    {
        ...
        PowerResource (PC01, 0x00, 0x0000)
        {
            ...
            Method (_ON, 0, Serialized)  // _ON_: Power On
            {
                ...
                Else
                {
                    If (LEqual (\_SB.PCI0.RP01.PXSX.DEOF, Zero))
                    {
        ...
        Method (GPS, 4, Serialized)
        {
            ...
            Switch (ToInteger (Arg2))
            {
                ...
                Case (0x13)
                {
                    ...
                    \_SB.PCI0.LPCB.EC0.EGPS ()
                    If (LAnd (ToInteger (PPST), \_SB.PCI0.LPCB.EC0.ERPL ()))
                    {
                        \_SB.PCI0.LPCB.EC0.EWPL (One)
                    }
                    Else
                    {
                        \_SB.PCI0.LPCB.EC0.EWPL (Zero)
                    }
                    ...
                    Switch (ToInteger (QUTP))
                    {
                        Case (Zero)
                        {
                            If (CPUT)
                            {
                                ...
                                Divide (Subtract (\_TZ.TZ01._TMP (), \_TZ.TBSE), 0x0A, Local0, Local1)
                                Store (Local1, PDTS)
                            }
    ...
    Scope (\_SB.PCI0.RP01.PXSX)
    {
        ...
        {
            Store (Zero, \_SB.PCI0.RP01.PXSX.DEOF)
            If (DGOS)
            {
                If (LNotEqual (\_SB.PCI0.RP01.PXSX.DPCS, Zero))
                {
