 ...
 *
 * Disassembly of SSDT-7-SKL-ULT.aml, Wed Dec 26 10:51:36 2018
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x0000381B (14363)
 *     Revision         0x01
 *     Checksum         0x05
 *     OEM ID           "XIAOMI"
...
DefinitionBlock ("", "SSDT", 1, "XIAOMI", "SKL-ULT", 0x00001000)
{
    ...
    External (_SB_.PCI0.LPCB.EC0_.COVT, IntObj)
    External (_SB_.PCI0.LPCB.EC0_.EGPS, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.LPCB.EC0_.ERPL, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.LPCB.EC0_.EWGC, MethodObj)    // 1 Arguments
    External (_SB_.PCI0.LPCB.EC0_.EWPL, MethodObj)    // 1 Arguments
    ...
    External (STMS, MethodObj)    // 1 Arguments
    ...
    Scope (\_SB.PCI0.RP01.PXSX)
    {
        OperationRegion (SGOP, SystemMemory, 0x7BBACF98, 0x0000004A)
    ...
    Scope (\_SB.PCI0.RP01.PXSX)
    {
        OperationRegion (NOPR, SystemMemory, 0x7CE69018, 0x00002010)
